    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="p-5">
                ...
                <form class="user" method="POST" action="{{ route('participant.login') }}">
                    @csrf
                ...
                <div class="text-center"><a class="small" href="{{ route('participant.password.request') }}">Forgot
                        Password?</a></div>
                <div class="text-center"><a class="small" href="{{ route('participant.register') }}">Create an Account!</a></div>
            </div>
        </div>
    </div>
@endsection
