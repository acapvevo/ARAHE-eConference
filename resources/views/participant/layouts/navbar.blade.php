            ...
            <li class="nav-item dropdown no-arrow">
                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false"
                        data-bs-toggle="dropdown" href="#"><span
                            ...
                            (Participant)</span><img class="border rounded-circle img-profile"
                            src="{{ Auth::user()->getImageURL() }}"></a>
                    <div class="dropdown-menu shadow dropdown-menu-end animated--grow-in">
                        <a class="dropdown-item" href="{{ route('participant.user.profile.view') }}">
                            <i class="fas fa-user fa-sm fa-fw me-2 text-gray-400"></i>&nbsp;Profile
                        </a>
                        <a class="dropdown-item" href="{{ route('participant.user.setting.view') }}">
