                        ...
                        <div class="header"
                            ...
                            <div class="logo emb-logo-margin-box"
                                ...
                                <div class="logo-center" align="center" id="emb-email-header"><img
                                        ...
                                        src="{{ asset('assets/img/email/arahe2.png') }}" alt="ARAHE LOGO"
                                        width="179" /></div>
                            </div>
                            <!--[if mso]></td></tr></table><![endif]-->
                        </div>
                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;">
                                        <div
                                            ...
                                            <h1 class="size-30"
                                                ...
                                                lang="x-size-30"><span
                                                    style="text-decoration: inherit;color: #0015ff;">Your Payment is
                                                </span></h1>
                                            <h1 class="size-30"
                                            ...
                                            <p class="size-16"
                                                ...
                                                lang="x-size-16">Your payment for
                                                {{ $bill->summary->registration->code }}:{{ $bill->id }} has been
                                                completed. The
                                                receipt for the payment has been attached to this email. Below is the
                                                detail of your payment.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <p style="Margin-top: 0;Margin-bottom: 0;"><span
                                                    style="text-decoration: inherit;color: #0015ff;"><strong>Date
                                                        Transaction</strong></span><br />
                                                {{ $bill->getTransactionDate() }}</p>
                                            <p style="Margin-top: 20px;Margin-bottom: 0;"><span
                                                    style="text-decoration: inherit;color: #0015ff;"><strong>Payment
                                                        Mode</strong></span><br />
                                                {{ $bill->getPaymentMethod() }}</p>
                                        </div>
                                    </div>
                                ...
                                <div class="column"
                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 12px;">
                                        <div
                                            style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                            <p style="Margin-top: 0;Margin-bottom: 0;"><span
                                                    style="text-decoration: inherit;color: #0015ff;"><strong>Amount</strong></span><br />
                                                {{ $bill->summary->getFormalOutputTotal() }}</p>
                                            <p style="Margin-top: 20px;Margin-bottom: 20px;"><span
                                                    style="text-decoration: inherit;color: #0015ff;"><strong>Payment
                                                        For</strong></span><br />
                                                ARAHE{{ $bill->summary->registration->form->session->year }}
                                                Registration
                                            </p>
                                        </div>
                                    </div>
