                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;">
                                        <div
                                            ...
                                            <h1 class="size-30"
                                                ...
                                                lang="x-size-30"><span
                                                    style="text-decoration: inherit;color: #0015ff;">{{ $mainMessage1 }}
                                                </span></h1>
                                            <h1 class="size-30"
                                                ...
                                                lang="x-size-30"><span
                                                    style="text-decoration: inherit;color: #0015ff;">{{ $mainMessage2 }}</span>
                                            </h1>
                                            <p class="size-16"
                                                style="Margin-top: 20px;Margin-bottom: 20px;font-size: 16px;line-height: 24px;text-align: center;"
                                                lang="x-size-16">{{ $secondaryMessage }}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <p style="Margin-top: 0;Margin-bottom: 0;"><span
                                                    style="text-decoration: inherit;color: #0015ff;"><strong>Registration ID</strong></span><br />
                                                {{ $registration->code }}</p>
                                            <p style="Margin-top: 20px;Margin-bottom: 0;"><span
                                                    style="text-decoration: inherit;color: #0015ff;"><strong>Category</strong></span><br />
                                                {{ $registration->category->name }}</p>
                                        </div>
                                    </div>
                                ...
                                <div class="column"
                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 12px;">
                                        <div
                                            style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                            <p style="Margin-top: 0;Margin-bottom: 0;"><span
                                                    style="text-decoration: inherit;color: #0015ff;"><strong>Register As</strong></span><br />
                                                {{ $registration->getType()->name }}</p>
                                            <p style="Margin-top: 20px;Margin-bottom: 20px;"><span
                                                    style="text-decoration: inherit;color: #0015ff;"><strong>Dietary Preference</strong></span><br />
                                                    {{ $registration->getDietary()->name }}
                                            </p>
                                        </div>
                                    </div>
