...
*/
    ...
    <style type="text/css">
        ...
        .mso .layout-has-border {
            border-top: 1px solid #081cf0;
            border-bottom: 1px solid #081cf0
        }
...
<body class="main half-padding" style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;">
    <!--<![endif]-->
    <table class="wrapper"
        style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #6471fa;"
            ...
            <tr>
                <td>
                        ...
                        <div class="header"
                            ...
                            <div class="logo emb-logo-margin-box"
                                ...
                                <div class="logo-center" align="center" id="emb-email-header"><img
                                        ...
                                        src="{{ asset('assets/img/email/arahe2.png') }}" alt=""
                                        width="179" /></div>
                            </div>
                            <!--[if mso]></td></tr></table><![endif]-->
                        </div>
                    ...
                    <div>
                        <div class="layout one-col fixed-width stack"
                            ...
                            <div class="layout__inner"
                                ...
                                <div class="column"
                                    style="text-align: left;color: #61606c;font-size: 14px;line-height: 21px;font-family: PT Serif,Georgia,serif;">
                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;">
                                        <div
                                            ...
                                            <h1 class="size-30"
                                                style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #0015ff;font-size: 26px;line-height: 34px;text-align: center;"
                                                lang="x-size-30"><span
                                                    style="text-decoration: inherit;color: #0015ff;">Your Paper
                                                    Submission is </span></h1>
                                            <h1 class="size-30"
                                                style="Margin-top: 20px;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #0015ff;font-size: 26px;line-height: 34px;text-align: center;"
                                                lang="x-size-30"><span
                                                    style="text-decoration: inherit;color: #0015ff;">Successfully
                                                    Submitted</span></h1>
                                            <p class="size-16"
                                                style="Margin-top: 20px;Margin-bottom: 20px;font-size: 16px;line-height: 24px;text-align: center;"
                                                lang="x-size-16">Your paper has been successfully submitted for
                                                ARAHE{{ $submission->registration->form->session->year }}. Our admin
                                                will review your paper and assign it to our
                                                expert reviewer if accepted. Below are your paper details.</p>
                                        </div>
                                    </div>
                        ...
                        <div class="layout two-col fixed-width stack"
                            ...
                            <div class="layout__inner"
                                ...
                                <div class="column"
                                    style="text-align: left;color: #61606c;font-size: 14px;line-height: 21px;font-family: PT Serif,Georgia,serif;max-width: 320px;min-width: 300px; width: 320px;width: calc(12300px - 2000%);Float: left;">

                                    <div
                                        style="Margin-left: 20px;Margin-right: 20px;Margin-top: 12px;Margin-bottom: 12px;">
                                        <div
                                            style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                            <p style="Margin-top: 0;Margin-bottom: 0;"><span
                                                    style="text-decoration: inherit;color: #0015ff;"><strong>Title</strong></span><br />
                                                {{ $submission->title }}</p>
                                            <p style="Margin-top: 20px;Margin-bottom: 0;"><span
                                                    style="text-decoration: inherit;color: #0015ff;"><strong>Keywords</strong></span><br />
                                                {{ $submission->keywords }}</p>
                                            <p style="Margin-top: 20px;Margin-bottom: 0;"><span
                                                    style="text-decoration: inherit;color: #0015ff;"><strong>Authors</strong></span><br />
                                                @foreach ($submission->authors as $index => $author)
                                                    {{ $submission->authors->keys()->last() == $index ? $author['name'] : $author['name'] . ', ' }}
                                                @endforeach
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 12px;">
                                        <div
                                            ...
                                            <p style="Margin-top: 0;Margin-bottom: 20px;"><span
                                                    style="text-decoration: inherit;color: #0015ff;"><strong>Abstract</strong></span><br />
                        ...
                        <div class="layout one-col fixed-width stack"
                            style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
                            <div class="layout__inner"
                                style="border-collapse: collapse;display: table;width: 100%;background-color: #6471fa;">
                                <!--[if mso]><table align="center" cellpadding="0" cellspacing="0" role="presentation"><tr class="layout-fixed-width" style="background-color: #6471fa;"><td style="width: 600px" class="w560"><![endif]-->
                                <div class="column"
                                    style="text-align: left;color: #61606c;font-size: 14px;line-height: 21px;font-family: PT Serif,Georgia,serif;">
                                    ...
                                    <div
                                        style="Margin-left: 20px;Margin-right: 20px;Margin-top: 12px;Margin-bottom: 12px;">
                                        <div class="divider"
                                            style="display: block;font-size: 2px;line-height: 2px;Margin-left: auto;Margin-right: auto;width: 40px;background-color: #081cf0;">
                                            &nbsp;</div>
                                    </div>
                    ...
                    <table style="border-collapse: collapse;table-layout: fixed;" cellpadding="0" cellspacing="0"
                        ...
                        <tbody>
                            <tr>
                                <td style="background-color: #6471fa">
                                            ...
                                            <div class="layout__inner left-aligned-footer"
                                                ...
                                                <div class="column"
                                                    ...
                                                    <div class="footer-logo emb-logo-margin-box"
                                                        ...
                                                        align="center">
                                                        <div style="margin-right: 20px;" emb-flexible-footer-logo
                                                            align="center"><img
                                                                style="border: 0;display: block;height: auto;width: 100%;max-width: 245px;"
                                                                src="{{ asset('assets/img/email/Logo-Mahe-1536x511.png') }}"
                                                                alt="" width="245" /></div>
                                                    </div>
                                                </div>
                                                <!--[if mso]></td><![endif]-->
                                                <!--[if mso]><td valign="top"><![endif]-->
                                                <div class="column"
                                                    style="text-align: left;font-size: 12px;line-height: 19px;color: #b3b3b3;font-family: PT Sans,Trebuchet MS,sans-serif;display: none;">
                                                    <div
                                                ...
                                                <!--[if mso]><td valign="top"><![endif]-->
                                                <table
                                                    style="border-collapse: collapse;table-layout: fixed;display: inline-block;width: 335px;"
                                                    cellpadding="0" cellspacing="0">
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <div class="column js-footer-additional-info"
                                                                    style="text-align: left;font-size: 12px;line-height: 19px;color: #b3b3b3;font-family: PT Sans,Trebuchet MS,sans-serif;width: 335px;">
                                                                    <div
                                                                        style="margin-left: 0;margin-right: 0;Margin-top: 10px;Margin-bottom: 10px;">
                                                                        <div class="email-footer__additional-info"
                                                                            ...
                                                                            <div bind-to="address">
                                                                                <p class="email-flexible-footer__additionalinfo--center"
                                                                                    ...
                                                                                    <span
                                                                                        style="text-decoration: inherit;color: #ffffff;"><strong>Malaysia&nbsp;Association&nbsp;of&nbsp;Home&nbsp;Economics
                                                                                            (MAHE)</strong></span>
                                                                                </p>
                                                                                <p class="email-flexible-footer__additionalinfo--center"
                                                                                    style="Margin-top: 0;Margin-bottom: 0;">
                                                                                    <span
                                                                                        style="text-decoration: inherit;color: #ffffff;">Department
                                                                                ...
                                                                                <p class="email-flexible-footer__additionalinfo--center"
                                                                                    style="Margin-top: 0;Margin-bottom: 0;">
                                                                                    <span
                                                                                        style="text-decoration: inherit;color: #ffffff;">Universiti
