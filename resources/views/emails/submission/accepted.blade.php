                        ...
                        <div class="header"
                            ...
                            <div class="logo emb-logo-margin-box"
                                ...
                                <div class="logo-center" align="center" id="emb-email-header"><img
                                        ...
                                        src="{{asset('assets/img/email/arahe2.png')}}" alt="" width="179" /></div>
                            </div>
                            <!--[if mso]></td></tr></table><![endif]-->
                        </div>
                    </div>
                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;">
                                        <div
                                            ...
                                            <h1 class="size-30"
                                                ...
                                                lang="x-size-30"><span
                                                    style="text-decoration: inherit;color: #0015ff;">Your Paper Have
                                                    Been Accepted</span></h1>
                                            <p class="size-16"
                                                style="Margin-top: 20px;Margin-bottom: 20px;font-size: 16px;line-height: 24px;text-align: center;"
                                                lang="x-size-16">Congratulation, Your Paper has been accepted for
                                                ARAHE{{$submission->registration->form->session->year}}. You may proceed to complete your payment in the
                                                Registration section if you have not yet paid.&nbsp;</p>
                                        </div>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <p style="Margin-top: 0;Margin-bottom: 0;">
                                                <font color="#0015ff"><strong>Title</strong></font><br />
                                                {{ $submission->title }}
                                            </p>
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <p style="Margin-top: 0;Margin-bottom: 0;"><span
                                                    style="text-decoration: inherit;color: #0015ff;"><strong>Mark</strong></span><br />
                                                {{ number_format($submission->calculatePercentage(), 2) }}%</p>
                                            <p style="Margin-top: 20px;Margin-bottom: 0;"><span
                                                    style="text-decoration: inherit;color: #0015ff;"><strong>Comment</strong></span><br />
                                                    ...
                                                    <div class="footer-logo emb-logo-margin-box"
                                                        ...
                                                        <div style="margin-right: 20px;" emb-flexible-footer-logo
                                                            align="center"><img
                                                                ...
                                                                src="{{asset('assets/img/email/Logo-Mahe-1536x511.png')}}" alt=""
                                                                width="245" /></div>
                                                    </div>
                                                </div>
                                                <!--[if mso]></td><![endif]-->
