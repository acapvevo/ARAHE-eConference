...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('super_admin.user.picture.update') }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('super_admin.user.password.update') }}" method="post">
                @csrf
                @method('PATCH')
