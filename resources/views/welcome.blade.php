        ...
        <div
          ...
          <div class="grid grid-cols-1 md:grid-cols-2">
            <div class="p-6">
              ...
              <div class="ml-12">
                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                  For managing the detail of papers, users activity and
                  reviewers activity.
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="ml-12">
                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                  Dashboard for Paper's reviewer. Paper will assign by admin.
                </div>
              </div>
            </div>
            ...
            <div class="p-6 border-t border-gray-200 dark:border-gray-700">
              ...
              <div class="ml-12">
                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                  Dashboard for user. For submit paper, abstract and other
                  stuff.
                </div>
              </div>
            </div>
